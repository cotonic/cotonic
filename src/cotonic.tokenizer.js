/**
 * Copyright 2016 The Cotonic Authors. All Rights Reserved.
 *
...
(function(cotonic) {
    ...
    function tokenize(data, builder, d) {
        var tag, attributes, text_data, has_slash, token,
    ...
    function tokenize_textarea(data, d) {
        var offsetStart = d.offset, lt, slash, n;
    ...
    function tokenize_comment(data, d) {
        var c1, c2, c3, offsetStart=d.offset;
        while(1) {
            ...
            if(c1 === undefined) {
                d.builder.comment(data.slice(offsetStart, offset));
                return NORMAL;
            }
    ...
    function tokenize_word(data, quote, d) {
        var c, charref, offsetStart = d.offset, acc=[];
    ...
    function tokenize_literal(data, d, type) {
        ...
        while(1) {
            ...
            if(type == "tag") {
                ...
                literal = tokenize_attribute(literal);
            }
    ...
    function find_qgt(data, d) {
        var offsetStart = d.offset, c1, c2;
    ...
    function tokenize_attr_value(key, data, d) {
        var c, s = skip_whitespace(data, d);
